...
public class StaxParserTest {
    ...
    public void testParseDevices() {
        ...
        ArrayList<Device> devicesStax = new ArrayList<>();
        devicesStax = (ArrayList<Device>) staxParser.parseDevices(xmlFile);
        ...
        Assert.assertEquals(devicesStax.size(),devicesTest.size());
        Assert.assertEquals(devicesStax.get(0).getId(),devicesTest.get(0).getId());
        Assert.assertEquals(devicesStax.get(0).getName(),devicesTest.get(0).getName());
